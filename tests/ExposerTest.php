...
class ExposerTest extends TestCase
{
    ...
    {
        $this->assertEquals('arg1arg2', $this->exposer->invokeMethod('protectedMethod', ['arg1', 'arg2']));
    ...
    {
        $this->assertEquals('You called: arg1', $this->exposer->invokeMethod('notAMethod', ['arg1']));
    ...
    {
        $this->assertEquals('I am protected', $this->exposer->getProperty('property'));
    ...
    {
        $this->assertEquals('You tried to get: notAProperty', $this->exposer->getProperty('notAProperty'));
